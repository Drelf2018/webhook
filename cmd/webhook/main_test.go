...
func (a *AutoGenerated) BeforeInitial() {
	a.StringFileInfo.ProductVersion = api.Version
	s := strings.Split(api.Version[1:], ".")
	convert := func(s string) (i int64) {
...
var _ initial.BeforeInitial1 = (*AutoGenerated)(nil)

func TestGenerate(t *testing.T) {
	versioninfo := initial.MustNew[AutoGenerated]()
